...
if errorlevel 45 set "INIT_MODE=proxy" && goto :restart_mock
if errorlevel 44 set "INIT_MODE=hybrid" && goto :restart_mock
if errorlevel 43 set "INIT_MODE=mock" && goto :restart_mock

...
import { openAIChatCompletion, injectCachedReasoning, storeReasoning, loadDisplayNameOverrides, initModelCtxMap } from "./openai-client.ts";
...
function getModelTier(modelId: string): "go" | "free" {
